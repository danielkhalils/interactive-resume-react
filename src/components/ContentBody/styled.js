...
export const IconKotlin = styled.button`
  position: absolute;
  width: 28px;
  height: 28px;
  left: 437px;
  ...
  background-color: #442434;
  border: none;
  background-image: url('./images/icons/kotlin.png');
  background-size: cover;
`;

export const IconFigma = styled.button`
  position: absolute;
  width: 28px;
  height: 28px;
  left: 482px;
...
export const IconDart = styled.button`
  position: absolute;
  width: 28px;
  height: 28px;
  left: 570px;
...
export const IconAngular = styled.button`
  position: absolute;
  width: 28px;
  height: 28px;
  left: 612px;
  ...
  background-color: #442434;
  border: none;
  background-image: url('./images/icons/angular.png');
  background-size: cover;
`;
...
export const IconSB = styled.button`
  position: absolute;
  width: 56px;
  height: 56px;
  left: 380px;
  ...
  background-color: #442434;
  border: none;
  background-image: url('./images/icons/spring.png');
  background-size: cover;
`;
...
export const IconFlutter = styled.button`
  position: absolute;
  width: 56px;
  height: 56px;
  left: 584px;
